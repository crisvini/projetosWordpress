...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<section class="introducao">
			<div class="container">
				...
				<a href="/Projetos/projetosWordPress/bikcraft/produtos/" class="btn">Orçamento</a>
			</div>
		</section>
		...
		<section class="produtos container animar">
			...
			<div class="call">
				...
				<a href="/Projetos/projetosWordPress/bikcraft/produtos/" class="btn btn-preto">Produtos</a>
			</div>
